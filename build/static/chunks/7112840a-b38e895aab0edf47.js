"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{19:function(e,t,r){r.d(t,{IO:function(){return query},PL:function(){return getDocs},ad:function(){return getFirestore},ar:function(){return where},hJ:function(){return collection}});var n,i,s=r(5816),a=r(8463),o=r(3333),l=r(4444),u=r(6640);r(3454);let c="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let g=new SortedMap(DocumentKey.comparator),E=new SortedMap(DocumentKey.comparator);function documentMap(...e){let t=E;for(let r of e)t=t.insert(r.key,r);return t}function __PRIVATE_convertOverlayedDocumentMapToDocumentMap(e){let t=E;return e.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function __PRIVATE_newDocumentKeyMap(){return new ObjectMap(e=>e.toString(),(e,t)=>e.isEqual(t))}new SortedMap(DocumentKey.comparator);let T=new SortedSet(DocumentKey.comparator);function __PRIVATE_documentKeySet(...e){let t=T;for(let r of e)t=t.add(r);return t}let I=new SortedSet(__PRIVATE_primitiveComparator);function __PRIVATE_targetIdSet(){return I}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
